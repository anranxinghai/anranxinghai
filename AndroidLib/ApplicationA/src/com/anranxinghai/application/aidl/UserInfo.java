...
@DatabaseTable(tableName=UserInfoProviderMetaDada.UserInfoTableMetaData.TABLE_NAME)
@DefaultContentUri(authority=UserInfoProviderMetaDada.AUTOHORITY , path=UserInfoProviderMetaDada.UserInfoTableMetaData.TABLE_NAME)
public class UserInfo implements Parcelable{
	
	public static final String USER_ID = UserInfoProviderMetaDada._ID;
