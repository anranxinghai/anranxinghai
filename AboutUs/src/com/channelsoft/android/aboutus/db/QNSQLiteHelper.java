package com.channelsoft.android.aboutus.db;
...
public class QNSQLiteHelper extends SQLiteOpenHelper
{
    public final static int    VERSION       = 1;            // 版本号
    public final static String TABLE_NAME    = "adInfo";      // 表名
    public final static String ID            = "id";         // 后面ContentProvider使用
    public final static String URL           = "url";
    public final static String TYPE          = "type";
    public final static String DESCRIPESION  = "description";
    public final static String AD_VERSION    = "ad_version";
    public static final String DATABASE_NAME = "about.db";

    public QNSQLiteHelper(Context context)
    {
    ...
    {
        String str_sql = "CREATE TABLE " + TABLE_NAME + "(" + ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + URL
                + " TEXT," + DESCRIPESION + " TEXT," + TYPE + " TEXT," + AD_VERSION + " INTEGER );";
